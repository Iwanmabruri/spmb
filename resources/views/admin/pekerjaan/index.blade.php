            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="text-truncate h5 mb-0" id="withLabel">List Data Pekerjaan</h3>
                    </div>
                    <div class="card-body">
            ...
            <div class="modal-dialog">
                <form action="{{ route('pekerjaan.update', $item->id) }}" method="POST">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <input type="text" name="nama_pekerjaan" value="{{ $item->nama_pekerjaan }}"
                                class="form-control">
                        </div>
