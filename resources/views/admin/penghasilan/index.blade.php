...
@section('konten')
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-12">
                ...
                <div class="mb-8 d-md-flex justify-content-between align-items-center">
                    <div>
                        <h1 class="mb-3 h2">Penghasilan</h1>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="text-truncate h5 mb-0" id="withLabel">List Data Penghasilan</h3>
                    </div>
                    <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    ...
                                                    <form action="{{ route('penghasilan.delete', $item->id) }}"
                                                        method="post">
                                                        @csrf
                                                        <button type="submit"
            ...
            <form action="{{ route('penghasilan.store') }}" method="POST">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Tambah Data Penghasilan</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                    </div>

                    <div class="modal-body">
                        <input type="text" name="kategori" class="form-control" placeholder="Kategori Penghasilan">
                    </div>
    ...
    @foreach ($data as $item)
        <div class="modal fade" id="modalEdit{{ $item->id }}" tabindex="-1">
            <div class="modal-dialog">
                <form action="{{ route('penghasilan.update', $item->id) }}" method="POST">
                    @csrf

                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Edit Data Penghasilan</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                        </div>
