                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    ...
                                                    <button type="button"
                                                        class="btn btn-outline-danger btn-icon btn-sm btn btnDelete"
                                                        data-id="{{ $item->id }}">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                            height="24" viewBox="0 0 24 24" fill="none"
                                                            stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
            ...
            <div class="modal-dialog">
                <form action="{{ route('agama.update', $item->id) }}" method="POST">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <input type="text" name="nama_agama" value="{{ $item->nama_agama }}" class="form-control">
                        </div>
                ...
                button.addEventListener('click', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            form.method = 'POST';
                            form.action = '/admin/agama/delete/' + id;
