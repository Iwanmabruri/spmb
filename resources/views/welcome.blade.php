...
<!-- Mirrored from landkit.goodthemes.co/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Aug 2025 10:18:37 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <!-- Map CSS -->
    <link rel="stylesheet" href="{{ asset('assets') }}/v0.53.0/mapbox-gl.css">
...
<body>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="text-center">
                        <img src="{{ asset('assets') }}/img/illustrations/illustration-1.png" alt="..."
                ...
                <div class="card card-row">
                    <div class="row gx-0">
                        <div class="col-12 col-md-6 bg-cover card-img-start"
                            style="background-image: url({{ asset('assets') }}/img/photos/photo-8.jpg);">

                            <!-- Image (placeholder) -->
                            <img src="{{ asset('assets') }}/img/photos/photo-8.jpg" alt="..."
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="card card-row">
                    <div class="row gx-0">
                        <div class="col-12 col-md-6 bg-cover card-img-start"
                            style="background-image: url({{ asset('assets') }}/img/photos/photo-1.jpg);">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="card">
                    ...
                    <!-- Image -->
                    <img src="{{ asset('assets') }}/img/photos/photo-21.jpg" alt="..." class="card-img-top">
                ...
                <div class="modal-body">
                    ...
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" id="modalPaymentName" type="text"
    ...
    <nav class="navbar navbar-expand-lg bg-white">
        <div class="container">
            ...
            <a class="navbar-brand" href="index.html">
                <img src="{{ asset('assets') }}/img/brand.png" class="navbar-brand-img" alt="Logo"
                    width="50">
            </a>
                    ...
                    <ul class="list-unstyled list-inline list-social mb-6 mb-md-0">
                        <li class="list-inline-item list-social-item me-3">
                            <a href="#!" class="text-decoration-none">
                                <img src="{{ asset('assets') }}/img/icons/social/instagram.svg"
                                    class="list-social-icon" alt="...">
                            </a>
                        </li>
                        <li class="list-inline-item list-social-item me-3">
                            <a href="#!" class="text-decoration-none">
                                <img src="{{ asset('assets') }}/img/icons/social/facebook.svg"
                                    class="list-social-icon" alt="...">
                            </a>
                        </li>
                        <li class="list-inline-item list-social-item me-3">
                            <a href="#!" class="text-decoration-none">
                                <img src="{{ asset('assets') }}/img/icons/social/twitter.svg"
                                    class="list-social-icon" alt="...">
                            </a>
                        </li>
                        <li class="list-inline-item list-social-item">
                            <a href="#!" class="text-decoration-none">
                                <img src="{{ asset('assets') }}/img/icons/social/pinterest.svg"
                                    class="list-social-icon" alt="...">
                            </a>
                        </li>
                    </ul>
    ...
    <!-- JAVASCRIPT -->
    <!-- Map JS -->
    <script src='{{ asset('assets') }}/v0.53.0/mapbox-gl.js'></script>
...
<!-- Mirrored from landkit.goodthemes.co/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Aug 2025 10:19:12 GMT -->
