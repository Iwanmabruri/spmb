        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-12 col-md-5 col-lg-6 order-md-2">
                    ...
                    <!-- Image -->
                    <img src="{{ asset('assets') }}/img/illustrations/illustration-2.png"
            ...
            <div class="row align-items-center justify-content-between mb-8 mb-md-11">
                <div class="col-12 col-md-6 order-md-2" data-aos="fade-left">
                    ...
                    <h2>
                        ...
                        <span class="text-success">ever created for <span
                                data-typed='{"strings": ["developers.", "founders.", "designers."]}'></span></span>
                    </h2>
                ...
                <div class="col-12 col-md-5 col-lg-6">
                    ...
                    <div class="w-md-150 w-lg-130 position-relative" data-aos="fade-left">
                        ...
                        <div class="img-skewed img-skewed-start">
                            ...
                            <!-- Image -->
                            <img src="{{ asset('assets') }}/img/screenshots/desktop/dashkit.jpg"
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-md-10 col-lg-8 text-center">
                    ...
                    <p class="fs-lg text-body-secondary mb-7 mb-md-9">
                        We don't like to brag, but we don't mind letting our customers do it for us. Here are a few nice
                        ...
                        <div class="row gx-0">
                            <div class="col-12 col-md-6">
                                ...
                                <div class="card-img-slider"
                                    ...
                                    <a class="card-img-start position-absolute d-block w-100 bg-cover"
                                    ...
                                    <a class="card-img-start position-absolute d-block w-100 bg-cover"
                                        style="background-image: url({{ asset('assets') }}/img/photos/photo-26.jpg);"
                                        href="#!">

                                        <!-- Image (placeholder) -->
                                        <img src="{{ asset('assets') }}/img/photos/photo-26.jpg" alt="..."
                                            class="img-fluid d-md-none invisible">
                                    ...
                                    <div class="w-100">
                                        ...
                                        <div class="card-body">
                                            <blockquote class="blockquote text-center mb-0">
                                                ...
                                                <!-- Text -->
                                                <p class="mb-5 mb-md-7">
                                                    “I've never used a theme as versatile and flexible as Landkit. It's
                                                    my go to for building landing sites on almost any project.”
                                                </p>
